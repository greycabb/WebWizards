...
const specialAvatarUrls = {
    ...
    "master": "https://webwizards.me/img/Avatars/Master.png"
};
...
export default class AvatarModal extends React.Component {
    constructor(props) {
        ...
        if (ud.points > 4999) {
            availableImgs.push(<img src={specialAvatarUrls.master} key={"master"} width="100px" onClick={() => this.handleImgChange(specialAvatarUrls.master)} className="avatar-img-preview"/>);
        }
